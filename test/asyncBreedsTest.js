...
describe('#breedDetailsFromFile', () => {
  it('provides, via callback, breed details for the Bombay breed', (done) => {
    breedDetailsFromFile('Bombay', function(bombay) {
...
// reason for done === is because function is the reason it is asyncronous. 
// the breedDetailsFromFile does not run without done parameter set and called